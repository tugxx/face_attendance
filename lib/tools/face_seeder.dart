...
// import '../app/services/face_aligner.dart';
...
//         List<double>? facePixels = await FaceAligner.alignFace(
//           srcImage, // Truyền path hoặc sửa hàm alignFace để nhận img.Image cho nhanh
//           mainFace,
//           targetSize: 112,
//           saveDebug: false,
//           debugName: name,
...
//         // Hoặc tốt hơn: Sửa FaceAlignerDart.alignFace nhận trực tiếp srcImage để đỡ load lại file
//         // Nhưng để tương thích code cũ, ta dùng hàm alignFace(String path)
//         // List<double>? facePixels = await FaceAlignerDart.alignFace(smallFile.path, mainFace);
